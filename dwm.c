...
enum { SchemeNorm, SchemeSel, SchemeHid, SchemeStatus }; /* color schemes */
...
struct Client {
	...
	int bw, oldbw;
	unsigned int tags;
	int ismax, wasfloating, isfixed, isfloating, isfreesize, isurgent, neverfocus, oldstate, isfullscreen;
	Client *next;
	Client *snext;
	Monitor *mon;
	Window win;
